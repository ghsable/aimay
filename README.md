...
* [Python](https://www.python.org/) [3.9.6](https://github.com/ghsable/aimay/blob/main/runtime.txt) + [navdeep-G/samplemod](https://github.com/navdeep-G/samplemod) + [modules](#modules)
...
| [Gunicorn](https://gunicorn.org/)                                | [gunicorn](https://pypi.org/project/gunicorn/)               | [benoitc/gunicorn](https://github.com/benoitc/gunicorn)                   | `20.1.0`                                                               | `-`                                                  |
...
| [Sphinx](https://www.sphinx-doc.org/en/main/)                    | [Sphinx](https://pypi.org/project/Sphinx/)                   | [sphinx-doc/sphinx](https://github.com/sphinx-doc/sphinx)                 | `4.1.2`                                                                | `-`                                                  |
| [Codecov](https://codecov.io/)                                   | [codecov](https://pypi.org/project/codecov/)                 | [codecov/codecov-python](https://github.com/codecov/codecov-python)       | `2.1.12`                                                               | `-`                                                  |
| [LINE Developers](https://developers.line.biz/ja/)               | [line-bot-sdk](https://pypi.org/project/line-bot-sdk/)       | [line/line-bot-sdk-python](https://github.com/line/line-bot-sdk-python)   | `1.20.0`                                                               | `LINE_CHANNEL_ACCESS_TOKEN`<br>`LINE_CHANNEL_SECRET` |
| [Flask](https://palletsprojects.com/p/flask/)                    | [Flask](https://pypi.org/project/Flask/)                     | [pallets/flask](https://github.com/pallets/flask)                         | `2.0.1`                                                                | `-`                                                  |
| ~[NewsAPI](https://newsapi.org/)~                                | ~[newsapi-python](https://pypi.org/project/newsapi-python/)~ | ~[mattlisiv/newsapi-python](https://github.com/mattlisiv/newsapi-python)~ | ~`0.2.6`~                                                              | ~`NEWSAPI_APIKEY`~                                   |
...
| [TMDb](https://www.themoviedb.org/?language=ja)                  | ~[tmdbv3api](https://pypi.org/project/tmdbv3api/)~           | ~[AnthonyBloomer/tmdbv3api](https://github.com/AnthonyBloomer/tmdbv3api)~ | ~`1.7.5`~                                                              | ~`TMDB_API_KEY`~                                     |
